angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/views/header.html',
    "<header class=\"row-fluid center-align\"><div class=\"row-fluid top-margin\"><h2 class=\"lightest-text text-shadow human\" style=text-transform:none>Golden Egg Room</h2></div></header>"
  );
