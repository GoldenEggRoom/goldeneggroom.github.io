angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/views/detail/ideas.detail.create.html',
    "<div class=row-fluid><div class=\"navi-bar-title dark\"><a class=navi-button-prev ng-click=\"setAnimationClass('moveleft')\" href=#/ideas/{{detailCtrl.current.id}}>Back</a><h1 class=\"human title\">Edit</h1></div><div class=\"row-fluid width-padding top-padding bottom-padding\"><div class=\"row-fluid center-align\"><div class=\"row-fluid bottom-margin\"><h1 class=\"punchy muted light-text-shadow\"><i class=\"icon icon-user small-right-margin\"></i></h1></div></div><div id=loadingContainer class=\"relative row-fluid\"><div class=\"row-fluid white-back withShadow withRadius width-padding top-padding bottom-padding center-align\"><div class=\"row-fluid left-align\"><form name=editForm class=form-horizontal novalidate><div class=control-group><label class=control-label for=inputTitle>Problem Statement</label><div class=controls><input style=width:97% ng-model=detailCtrl.editCurrent.title placeholder=Title required></div></div><div class=control-group><label class=control-label for=inputSummary>Problem Summary</label><div class=controls><input style=width:97% ng-model=detailCtrl.editCurrent.summary placeholder=Summary required></div></div><div class=control-group><div class=controls><button ng-click=detailCtrl.createIdea() class=\"btn btn-block btn-large btn-success\">Create Idea</button></div></div></form></div></div></div><div class=row-fluid></div></div><div class=row-fluid ng-include=\"\" src=\"'app/views/footer.html'\"></div></div>"
  );


  $templateCache.put('app/views/detail/ideas.detail.edit.html',
    "<div class=row-fluid><div class=\"navi-bar-title dark\"><a class=navi-button-prev ng-click=\"setAnimationClass('moveleft')\" href=#/ideas/{{detailCtrl.current.id}}>Back</a><h1 class=\"human title\">Edit</h1></div><div class=\"row-fluid width-padding top-padding bottom-padding\"><div class=\"row-fluid center-align\"><div class=\"row-fluid bottom-margin\"><h1 class=\"punchy muted light-text-shadow\"><i class=\"icon icon-user small-right-margin\"></i></h1></div></div><div id=loadingContainer class=\"relative row-fluid\"><div class=\"row-fluid white-back withShadow withRadius width-padding top-padding bottom-padding center-align\"><div class=\"row-fluid left-align\"><form name=editForm class=form-horizontal novalidate><div class=control-group><label class=control-label for=inputTitle>Problem Statement</label><div class=controls><input style=width:97% ng-model=detailCtrl.editCurrent.title placeholder=Title required></div></div><div class=control-group><label class=control-label for=inputSummary>Problem Summary</label><div class=controls><input style=width:97% ng-model=detailCtrl.editCurrent.summary placeholder=Summary required></div></div><div class=control-group><label class=control-label for=inputPitchVideoUrl>Pitch Video URL</label><div class=controls><input style=width:97% ng-model=detailCtrl.editCurrent.pitchVideoUrl placeholder=PicthVideoUrl></div></div><div class=control-group><div class=controls><button ng-click=detailCtrl.saveIdea() class=\"btn btn-block btn-large btn-success\">Save Idea</button></div></div></form></div></div></div><div class=row-fluid></div></div><div class=row-fluid ng-include=\"\" src=\"'app/views/footer.html'\"></div></div>"
  );


  $templateCache.put('app/views/detail/ideas.detail.html',
    "<div class=row-fluid><div class=\"navi-bar-title dark\"><a class=navi-button-prev href=/#><i class=\"icon icon-th-list small-right-margin\"></i>List</a><h1 class=\"human title\">{{detailCtrl.current.getTitle()}}</h1><a class=navi-button-main href=#/ideas/{{detailCtrl.current.id}}/edit>Edit</a></div><div class=\"row-fluid width-padding top-padding bottom-padding\"><div class=\"row-fluid center-align\"><div class=\"row-fluid bottom-margin\"><h1 class=\"punchy muted light-text-shadow\"><i class=\"icon icon-user small-right-margin\"></i></h1></div></div><div class=\"row-fluid white-back withShadow withRadius width-padding top-padding bottom-padding center-align\"><div class=row-fluid><div class=row-fluid><div class=\"row-fluid center-align\"><h4 class=punchy>Problem Statement</h4><span class=\"machine muted\">{{detailCtrl.current.getTitle()}}</span></div></div></div><span ng-if=detailCtrl.current.getPitchVideoUrl()><div class=\"horizontal-line full-fade top-margin bottom-margin\"></div><h4 class=punchy>Pitch Video</h4><iframe width=420 height=315 src={{trustSrc(detailCtrl.current.getPitchVideoUrl())}} frameborder=0 allowfullscreen></iframe></span><div class=\"horizontal-line full-fade top-margin bottom-margin\"></div><h4 class=punchy>Pitch Summary</h4><span class=\"machine muted\">{{detailCtrl.current.getSummary()}}</span><div class=\"horizontal-line full-fade top-margin bottom-margin\"></div><h4 class=punchy>Traction ({{detailCtrl.current.getTraction()}})</h4><table><tr><td>{{detailCtrl.current.getVotes()}}</td><td>votes</td></tr><tr><td>{{detailCtrl.current.getEducatorCommitment()}}</td><td>educators committed</td></tr><tr><td>{{detailCtrl.current.getDevCommitment()}}</td><td>developers committed</td></tr><tr><td>{{detailCtrl.current.getDesignCommitment()}}</td><td>designers committed</td></tr><tr><td>${{detailCtrl.current.getMonetaryCommitment()}}.00</td><td>committed</td></tr></table><button ng-click=detailCtrl.vote() class=\"btn btn-block btn-large btn-success\">Vote Up!</button> <button class=\"btn btn-block btn-large btn-success\">Commit!</button></div></div><div class=row-fluid ng-include=\"\" src=\"'app/views/footer.html'\"></div></div>"
  );
  ...
  $templateCache.put('app/views/detail/ideas.html',
    "<div class=row-fluid><div class=\"navi-bar-title dark\"><h1 class=\"human title\">Welcome to the Golden Egg Room!</h1></div><div class=\"row-fluid width-padding top-padding bottom-padding\"><div class=featured-idea><iframe ng-src={{trustSrc(featuredIdea.getPitchVideoUrl())}} frameborder=0 allowfullscreen></iframe><a class=next-link ng-click=nextFeature()>Next Pitch</a><div class=description><div class=traction><h3>TRACTION</h3><span>{{featuredIdea.getTraction()}}</span></div><h3>{{featuredIdea.getTitle()}}</h3><p>\"{{featuredIdea.getSummary()}}\"</p></div></div><div class=\"row-fluid white-back withShadow withRadius center-align\"><a href=#/ideas/{{item.id}} class=\"block row-fluid top-padding bottom-padding relative light-border-bottom white-border-top\" ng-repeat=\"item in ideasCtrl.collection.models\" ng-animate=\"{ enter: 'waveForward-enter', leave: 'waveForward-leave' }\"><div class=\"span90-10 muted\"><div class=\"row-fluid tiny-bottom-margin\"><div class=\"span20-80 right-align\"></div><div class=\"span80-20 left-align\"><div class=\"small-left-margin machine\"><h3>{{item.getTitle()}}</h3></div></div></div><span ng-if=item.getPitchVideoUrl()><iframe width=560 height=315 ng-src={{trustSrc(item.getPitchVideoUrl())}} frameborder=0 allowfullscreen></iframe></span><div class=row-fluid><div class=\"span20-80 right-align\"><span class=\"machine bold\">Details:</span></div><div class=\"span80-20 right-align\"><span class=\"small-left-margin machine\">{{item.getSummary()}}</span></div></div></div><div class=\"span10-90 muted center-align small-top-padding\"><div class=small-top-margin><i class=\"icon icon-chevron-right\"></i></div></div></a></div></div><div class=row-fluid ng-include=\"\" src=\"'app/views/footer.html'\"></div></div>"
  );
  ...
  $templateCache.put('app/views/header.html',
    "<header class=\"row-fluid center-align\"><div class=\"row-fluid top-margin\"><h2 class=\"lightest-text text-shadow human\" style=text-transform:none>Golden Egg Room</h2><div style=float:right><a class=lnk-login href=#/facebook>Log in</a><div class=user-info style=color:blue></div></div><div style=clear:both></div></div></header>"
  );
